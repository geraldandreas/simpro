...
import JadwalPengujiDosenClient from "./jadwalmengujisidangclient"; // Pastikan import sesuai dengan nama file client.tsx Anda

export const dynamic = "force-dynamic";

// ================= SKELETON COMPONENT =================
// Skeleton ini secara spesifik mereplikasi UI dari halaman Jadwal Sidang Dosen
function SkeletonJadwalPengujiSidangDosen() {
  return (
      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden">
        <div className="flex-1 overflow-y-auto p-10 custom-scrollbar">
          <div className="max-w-[1400px] mx-auto w-full">
            ...
            <div className="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/40 overflow-hidden border border-white flex flex-col min-h-[500px]">
...
// ================= PAGE WRAPPER =================
export default function JadwalPengujiDosenPage() {
  return (
    <Suspense fallback={<SkeletonJadwalPengujiSidangDosen />}>
      <JadwalPengujiDosenClient />
    </Suspense>
  );
}