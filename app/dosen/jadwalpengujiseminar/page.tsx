...
import JadwalPengujiDosenClient from "./jadwalpengujiseminarclient"; // Pastikan path ini sesuai dengan nama file client.tsx Anda

export const dynamic = "force-dynamic";

// ================= SKELETON COMPONENT =================
// Skeleton ini mereplikasi layout spesifik halaman Jadwal Penilaian & Menguji Dosen
function SkeletonJadwalPengujiDosen() {
  return (
...
export default function JadwalPengujiDosenPage() {
  return (
    <Suspense fallback={<SkeletonJadwalPengujiDosen />}>
