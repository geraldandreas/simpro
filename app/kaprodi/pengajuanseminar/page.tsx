...
import PengajuanSeminarKaprodiClient from "./pengajuanseminarkaprodiclient"; // Pastikan path ini sesuai nama file client.tsx Anda

export const dynamic = "force-dynamic";

// ================= SKELETON COMPONENT =================
function SkeletonPengajuanSeminar() {
  return (
    <div className="min-h-screen bg-[#F8F9FB] font-sans text-slate-700 animate-pulse">
      <main className="p-10 max-w-[1400px] mx-auto w-full">
        ...
        <div className="mb-10 flex items-end justify-between">
          ...
          <div className="hidden lg:block h-10 w-40 bg-slate-200 rounded-xl"></div>
        </div>
...
// ================= PAGE WRAPPER =================
export default function PengajuanSeminarKaprodiPage() {
  return (
    <Suspense fallback={<SkeletonPengajuanSeminar />}>
      <PengajuanSeminarKaprodiClient />
    </Suspense>
  );
}