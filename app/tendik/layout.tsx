...
import Sidebar from "@/components/sidebar-tendik"; // Sesuaikan jika nama file sidebar tendik berbeda (misal: sidebar-tendik)
import NotificationBell from '@/components/notificationBell'; 

export default function TendikLayout({
  children,
}: {
